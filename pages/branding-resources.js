...
const BrandingResources = () => {
    ...
    return (
        <>
        <Head>
        <title>Branding Resources</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
            ...
            <div className={`${styles.iconSection} py-5`}>
                ...
                <div>
                    <img src="/Images/Brand/SpamburnerIcon.svg" alt="" width="100" height="100" className="d-inline-block align-text-top me-2" />
                </div>

                <div className='d-flex gap-5'>
                    <div className='d-flex flex-column gap-3'>
                        <div className={styles.brandingIcons} >
                            <img src="/Images/Branding page/Spamburner icon_1.svg" alt="" width="65" height="65" />
                        </div>
                        <div className={styles.brandingIcons}>
                            <img src="/Images/Branding page/Spamburner icon_4.svg" alt="" width="65" height="65" />
                        </div>
                    </div>
                    <div className='d-flex flex-column gap-3'>
                        <div className={styles.brandingIcons}>
                            <img src="/Images/Branding page/Spamburner icon_2.svg" alt="" width="65" height="65" />
                        </div>
                        <div className={styles.brandingIcons}>
                            <img src="/Images/Branding page/Spamburner icon_5.svg" alt="" width="65" height="65" />
                        </div>
                    </div>
                    <div className='d-flex flex-column gap-3'>
                        <div className={styles.brandingIcons}>
                            <img src="/Images/Branding page/Spamburner icon_3.svg" alt="" width="65" height="65" />
                        </div>
                        <div className={styles.brandingIcons}>
                            <img src="/Images/Branding page/Spamburner icon_6.svg" alt="" width="65" height="65" />
                        </div>
                    </div>
                </div>
            </div>
